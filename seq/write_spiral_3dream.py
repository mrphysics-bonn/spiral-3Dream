...
# General
seq_name        = "3Dream_b0corr_ph_5mm_N5_acc5_Rz1"      # sequence/protocol filename
meas_date       = None
plot            = False         # plot sequence (refscans & noisescans will be deactivated)

# Sequence - Contrast and Geometry
fov             = 200           # field of view [mm]
TR              = 8.00          # repetition time [ms]
TE_ste          = 0.72          # STE/ STE* echo time [ms]
TE_fid          = 4.28          # FID echo time [ms]
res             = 5           # in plane resolution [mm]                   
Nz              = 40            # number of partitions
...
TM              = 1.42          # mixing time: time span between the 2nd alpha and 1st beta pulse -> small compared to T1 relaxation time [ms]
...
Nintl           = 5             # spiral interleaves
redfac          = 5             # in-plane acceleration factor, recommended: 3
spiral_os       = 1             # spiral oversampling in center
Rz              = 1             # acceleration factor in kz direction, recommended: 2
caipi_shift     = redfac-1      # CAIPI-shift

# T1 estimation for global filter approach
t1              = 0.84             # expected T1 value [s] (840ms GUFI, 2s grey matter)
